...
# 
Table_01<- as.data.frame(Ecosystem_Report_4X_objectives)
# 
...
```{r nafo4xSSTanomaly,fig.align="center", echo = FALSE,fig.width = 5, out.width="60%", fig.cap="The annual sea-surface-temperature normalized anomaly for NAFO 4X derived from satellite imagery compared to their long-term monthly means. Horizontal dashed lines represent plus or minus 0.5 SD for the 1991-2020 period. Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively. "}
...
```{r nafo4xSSTBT, fig.align="center", echo = FALSE,fig.width = 14, fig.pos='H',fig.cap="Sea Surface Temperature from satellite and Bottom temperature for 4X. Dotted lines denote the long-term mean."}
