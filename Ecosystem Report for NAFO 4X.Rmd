...
```{r, fig.align="center", echo = FALSE,fig.width = 10, fig.height=7, fig.cap ="Figure 6. Commercial landings collected from NAFO, ZIF and MARFIS databases for species categories in NAFO 4X. Dotted lines represent the long-term means."}
...
```{r fig.align="center", echo = FALSE,fig.width = 5, fig.height=4, fig.cap="Figure 9. Large fish indicator from RV survey data."}
dat.dir<-here::here("data")
eco_indicators_nafo<- "eco_indicators_nafo.Rdata"
  load(file.path(dat.dir, eco_indicators_nafo))
...
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=7, fig.cap="Figure 10. Total Biomass and guild-level biomasses for fish and invertebrate catagories from DFO's Summer RV survey which have been corrected for catchability. Dotted lines denote long-term means."}
dat.dir<-here::here("data")
eco_indicators_nafo<- "eco_indicators_nafo.Rdata"
  load(file.path(dat.dir, eco_indicators_nafo))
