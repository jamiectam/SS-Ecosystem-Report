...
```{r, fig.align="center", echo = FALSE,fig.width = 14, fig.cap="Figure 7. Sea Surface Temperature from satellite and Bottom temperature for 4X. Dotted lines denote the long-term mean."}
...
```{r ,fig.align="center", echo = FALSE,fig.width = 10, fig.height=7, fig.cap="Figure 5. Fishing pressure from 1970-2020 calculated from DFO Summer Research Vessel survey and has been corrected for catchability. Dotted lines denote long-term means."}
...
```{r, fig.align="center", echo = FALSE,fig.width = 10, fig.height=7, fig.cap ="Figure 6. Commercial landings collected from NAFO, ZIF and MARFIS databases for species categories in NAFO 4X. Dotted lines represent the long-term means, grey areas are the latest 5 years of available data."}
...
### Chlorophyll, Bloom_Start, Nitrate, *Calanus finmarchicus*,  Zooplankton Biomass
[Casault et al. 2024](https://publications.gc.ca/collections/collection_2024/mpo-dfo/Fs97-6-3589-eng.pdf)
...
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=10, fig.cap="Figure 8. Chlorophyll (surface) and Bloom Start,for the Western Scotian Shelf (including NAFO 4X and 5Y),  Nitrate 0-50m, Nitrate 50-150, from Browns Bank Line (BBL)  C.finmarchicus, and meso zooplankton biomass (dry weight), from NAFO 4X. Dotted lines denote long-term means, grey areas are the latest 5 years of available data. "}
dat.dir<-here::here("data")
...
```{r fig.align="center", echo = FALSE,fig.width = 5, fig.height=4, fig.cap="Figure 9. Large fish indicator from RV survey data. Dotted line denotes the long-term mean, grey area represents the most recent 5 years of available data."}
dat.dir<-here::here("data")
eco_indicators_nafo<- "eco_indicators_nafo.Rdata"
  load(file.path(dat.dir, eco_indicators_nafo))
...
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=7, fig.cap="Figure 9. Shannon diversity Index, Margalef Richness, Hieps Evenness measured from data collected from DFO's Summer RV survey and has been corrected for catchability. Dotted lines denote long-term means."}
dat.dir<-here::here("data")
eco_indicators_nafo<- "eco_indicators_nafo.Rdata"
  load(file.path(dat.dir, eco_indicators_nafo))
...
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=7, fig.cap="Figure 10. Total Biomass and guild-level biomasses for fish catagories from DFO's Summer RV survey which have been corrected for catchability. Invertebrate estimates are not corrected for catchability. Dotted lines denote long-term means, grey areas represent the last 5 years of available data."}
dat.dir<-here::here("data")
eco_indicators_nafo<- "eco_indicators_nafo.Rdata"
  load(file.path(dat.dir, eco_indicators_nafo))
