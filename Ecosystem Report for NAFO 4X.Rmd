...
```{r,fig.align="center", echo = FALSE,fig.width = 5, out.width="60%", fig.cap="The annual sea-surface-temperature normalized anomaly for NAFO 4X derived from satellite imagery compared to their long-term monthly means. Horizontal dashed lines represent plus or minus 0.5 SD for the 1991-2020 period. Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively. "}
...
```{r,fig.align="center", echo = FALSE, fig.width = 5,fig.pos='H', out.width="60%", fig.cap="Time series of July bottom-temperature anomalies (thin lines with circles) and five-year-running-mean filtered series (heavy line) for NAFO 4X The solid horizontal line is the 1991-2020 mean and dashed lines represent ±0.5 SD. Regime shift analysis results from running the method forwards and backwards on the time series depicted by the blue and red horizontal lines, respectively."}
...
```{r, fig.align="center", echo = FALSE,fig.width = 14, fig.pos='H',fig.cap="Sea Surface Temperature from satellite and Bottom temperature for 4X. Dotted lines denote the long-term mean."}
...
```{r,fig.align="center", echo = FALSE,fig.width = 8, out.width="80%",fig.pos='H', fig.cap="Future scenarios for sea surface temperature changes."}
...
```{r ,fig.align="center", echo = FALSE,fig.width = 10, fig.height=7,fig.pos='H', fig.cap="Fishing pressure from 1970-2020 calculated from DFO Summer Research Vessel survey and has been corrected for catchability. Dotted lines denote long-term means."}
...
```{r fig.align="center", echo = FALSE,fig.width = 10, fig.height=7,fig.pos='H', fig.cap="Shannon diversity Index, Margalef Richness, Hieps Evenness measured from data collected from DFO's Summer RV survey and has been corrected for catchability. Dotted lines denote long-term means."}
dat.dir<-here::here("data")
eco_indicators_nafo<- "eco_indicators_nafo.Rdata"
  load(file.path(dat.dir, eco_indicators_nafo))
