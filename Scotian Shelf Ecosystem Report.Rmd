---
title: "Scotian Shelf Ecosystem Report"
...
We emphasize that this is a guide to the most current information on socio-ecological systems specific to the Scotian Shelf and indicators and synthesis continue to develop. 
...
```{r, echo=FALSE,message=FALSE, warning=FALSE, include=FALSE}
#calculate all SSdata

```

```{r, echo=FALSE,message=FALSE, warning=FALSE, include=FALSE}
#calculate all indicators in marindicator

```

```{r, echo=FALSE,message=FALSE, warning=FALSE, include=FALSE}
#collect environmental data from azmpdata
